...
{
public:
  StaticTFBroadcaster() : Node("OOI_frame_broadcaster")
  {
    ...
    transformStamped_.child_frame_id = "OOI_frame";
    // Position
    transformStamped_.transform.translation.x = 0.5;
    transformStamped_.transform.translation.y = 0.2;
    transformStamped_.transform.translation.z = 0.4;
    // Rotation
    tf2::Quaternion q;
